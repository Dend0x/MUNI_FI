...
def binary_search_recursive(
    ...
    if array[middle] == key:
        return middle
    if array[middle] < key:
        return binary_search_recursive(array, middle + 1, right, key)
    else:
        return binary_search_recursive(array, left, middle - 1, key)
...
def min_max_search_recursive(
    ...
    leftMin, leftMax = min_max_search_recursive(array, left, middle)
    rightMin, rightMax = min_max_search_recursive(array, middle + 1, right)
...
def min_max_search_iterative(
    ...
    if array[left] < array[left + 1]:
        minimum = array[left]
        maximum = array[left + 1]
    else:
        minimum = array[left + 1]
        maximum = array[left]
